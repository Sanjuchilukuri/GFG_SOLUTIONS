<h2><a href="https://practice.geeksforgeeks.org/problems/handshakes1303/1?page=1&difficulty[]=1&category[]=Recursion&sortBy=accuracy">Handshakes</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">We have N&nbsp;persons sitting on a round table. Any person can do a handshake with any other person. </span></p>
